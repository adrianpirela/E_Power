...
<div class="container">
			<div class="row text-center">
				<div class="col-md-4 col-md-offset-4">
					<h2 align="center">Seleccione la pre renta a eliminar</h2>
					<div class="divider"></div>
					<p align="center">Seleccione el numero de registro de la pre renta a eliminar.</p>
				<br>
					<form action="modulos/eliminar_pre.php" method="post">
