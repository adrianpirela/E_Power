...
<section>
	<div class="container">
		<form class="col s6" action="control.php" method="post">
    <br>
		<h4 class="center-align">Inicio de Sesion</h4>
    <br>
			<div class="divider"></div>
      <br>
      <h5 class="center-align">Ingrese su correo y contraseña para iniciar sesion.</h5>
			<br>
      <br>
        <div class="row">
          <div class="col s12 m12 l8 offset-l2">
           <div class="input-field col s12">
            ...
            <label for="email_re" data-error="Correo Invalido" data-success="Correo Validado">Correo</label>
          </div>
        </div>
      </div>
      <div class="row">
      <div class="col s12 m12 l8 offset-l2">
        <div class="input-field col s12 m12 l12">
          ...
          <a href="index.php?pag=forgot">¿Olvido su contraseña?</a>
        </div>
      </div>
	  </div>
    <br>
